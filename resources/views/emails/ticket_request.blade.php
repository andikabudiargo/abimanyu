    ...
    <td align="center" bgcolor="#4a4a4a" style="padding: 20px;">
        <img src="https://drive.google.com/uc?export=view&id=1A5osBrOLECFWTwqeuoCr3wTQAtPS1iwO" 
             ...
             style="display: block; max-width: 100%; height: auto;">
                    ...
                    <!-- Tombol lihat detail -->
                    <tr>
                        <td>Dear Mr. Joko Sriyanto ,<br><br>
                        <i>We kindly request you to approve the latest ticket submission so that it can be promptly processed by the IT/Maintenance team.</i><br><br>
                        Thank you for your attention and cooperation</td>
                    </tr>
                    <tr>
