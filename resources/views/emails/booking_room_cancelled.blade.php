...
<body style="font-family: Arial, sans-serif; background-color: #f6f6f6; padding: 20px;">
 ...
 <tr>
                        <td>
                           <h2>Your Room Booking Has Been Cancelled ❌</h2>
                        </td>
  <!-- Tombol lihat detail -->
                    <tr>
                     <td>
<p>
    Your booking for <strong>{{ $booking->room->name }}</strong> on 
    <strong>{{ \Carbon\Carbon::parse($booking->booking_date)->format('l, d M Y') }}</strong>,
    from {{ \Carbon\Carbon::parse($booking->start_time)->format('H:i') }} to 
    {{ \Carbon\Carbon::parse($booking->end_time)->format('H:i') }} 
    has been <strong style="color:red;">Cancelled</strong>.
</p>
...
<p>
    ...
    Please feel free to make another booking at a different time that works for you.
</p>
