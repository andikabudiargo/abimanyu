...
@section('page-title', 'DASHBOARD ARTICLE')
@section('breadcrumb-item', 'Inventory')
@section('breadcrumb-active', 'Article')

@section('content')

   <div class="bg-white shadow rounded-xl p-6 mb-6">
    <h2 class="text-lg font-semibold mb-4">Filter Article</h2>
    ...
    <form id="filter-form">
        ...
        <div class="flex justify-start gap-2 mt-6">
            ...
            <a href="{{ route('inventory.article.create') }}" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg shadow">Create</a>
        </div>
    </form>
</div>
...
<div class="table-responsive bg-white shadow rounded-xl p-6 mb-2">
    <h2 class="text-lg font-semibold mb-2">List Article</h2>
    <div class="w-full overflow-x-auto" id="article-scroll-wrapper">
    <table id="article-table" class="min-w-full text-sm text-left whitespace-nowrap">
            <thead class="bg-blue-500 text-white uppercase text-xs font-bold tracking-wider">
                <tr>
                    <th class="px-4 py-2">Action</th>
                    <th class="px-4 py-2">Article Type</th>
                    <th class="px-4 py-2">Cust/Supp</th>
...
$(document).ready(function() {
    ...
    feather.replace(); // <-- WAJIB di sini
        ...
        ajax: {
            url: "{{ route('inventory.article.data') }}",
            data: function (d) {
      ...
      dom: '<"flex justify-between items-center mb-2"l<"flex"fB>>r<"table-scroll-wrapper"t><"flex justify-between items-center"ip>',
        ...
        columns: [
            ...
            { data: 'article_type', name: 'article_type' },
            { data: 'supplier.name', name: 'supplier.name' },
            { data: 'article_code', name: 'article_code' },
            { data: 'description', name: 'description' },
            { data: 'unit', name: 'unit' },
            { data: 'qr_code_path', name: 'qr_code_path', orderable: false, searchable: false },
