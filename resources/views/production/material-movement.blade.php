...
@section('page-title', 'DASHBOARD MATERIAL MOVEMENT')
@section('breadcrumb-item', 'Production Material')
@section('breadcrumb-active', 'Material Movement')

@section('content')

   <div class="bg-white shadow rounded-xl p-6 mb-6">
    <h2 class="text-lg font-semibold mb-4">Filter Material Movement</h2>

    <form id="filter-form">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <div>
                <label for="filterCode" class="block text-sm mb-1 font-medium text-gray-700">Code</label>
            ...
            <div>
                <label for="filterCode" class="block text-sm mb-1 font-medium text-gray-700">Reference Number</label>
                <input type="text" id="filter-code" class="w-full px-3 py-1 text-base border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"/>
            </div>
            <div>
                <label for="filterCode" class="block text-sm mb-1 font-medium text-gray-700">Work Order Sheet</label>
                <input type="text" id="filter-code" class="w-full px-3 py-1 text-base border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"/>
            </div>
              <div>
    ...
    placeholder="YYYY-MM-DD to YYYY-MM-DD" autocomplete="off" />
          ...
          <div>
    <label for="filter-from" class="block text-sm mb-1 font-medium text-gray-700">Destination</label>
    <select id="filter-from" class="w-full px-3 py-1 text-base border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
        ...
        <div class="flex justify-start gap-2 mt-6">
            ...
            <a href="{{ route('production.mrc.create') }}" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg shadow">Create</a>
        </div>
    </form>
</div>
...
<div class="table-responsive bg-white shadow rounded-xl p-6 mb-2">
    <h2 class="text-lg font-semibold mb-2">Material Receiving List</h2>
    ...
    <table id="trin-table" class="min-w-full text-sm text-left whitespace-nowrap">
            <thead class="bg-blue-500 text-white uppercase text-xs font-bold tracking-wider">
                <tr>
                    ...
                    <th class="px-4 py-2 !text-center w-28" >Destination</th>
