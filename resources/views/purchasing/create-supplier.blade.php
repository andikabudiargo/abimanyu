...
@section('breadcrumb-item', 'Supplier Management')
@section('breadcrumb-active', 'Create Supplier')
...
<div class="w-full bg-white shadow-md rounded-xl p-4 space-y-6">
  ...
  <div class="flex justify-between items-center border-b pb-2 text-sm font-medium">
    ...
    <button type="button" 
      ...
      <span class="hidden sm:inline">Account & Payment</span>
    </button>
  </div>
    ...
    <div class="step">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        ...
        <label for="as_customer" class="text-sm text-gray-700">As Customer</label>
        </div>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
           <div>
       ...
       <select name="category" id="category"
        ...
        <input type="date" name="join_date" id="join_date"
         ...
         <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        <div>
        <label for="coa_hutang" class="block text-sm font-medium text-gray-700 mb-1">COA Hutang</label>
       <select name="coa_hutang" id="coa_hutang"
        ...
        <div>
        <label for="coa_retur" class="block text-sm font-medium text-gray-700 mb-1">COA Retur Pembelian</label>
       <select name="coa_retur" id="coa_retur"
                  class="w-full px-3 py-2 border border-gray-300 rounded shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
            <option value="">-- Pilih COA Retur --</option>
  ...
  <div class="relative">
    ...
    <div class="absolute inset-y-0 right-3 flex items-center pointer-events-none text-gray-500">
      Days
         ...
         <div class="flex items-center h-full pt-6">
        <input type="checkbox" name="pkp" value="1" checked class="form-checkbox text-indigo-600 mr-2">
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        ...
        <div class="col-span-2">
        <label for="bank_type" class="block text-sm font-medium text-gray-700 mb-1">Bank Type</label>
       <select name="bank_type" id="bank_type"
                  class="w-full px-3 py-2 border border-gray-300 rounded shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
            <option value="">-- Pilih Bank Type --</option>
            <option value="Retur">BCA</option>
            <option value="Transit">Non BCA</option>
          </select>
        </div>
</div>
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <div>
        <label for="account_bank_name" class="block text-sm font-medium text-gray-700 mb-1">Account Bank Name</label>
        <input type="text" name="account_bank_name" id="account_bank_name"
               class="w-full px-3 py-2 border border-gray-300 rounded shadow-sm focus:ring-indigo-500 focus:border-indigo-500" />
        </div>
        <div>
        <label for="account_bank_number" class="block text-sm font-medium text-gray-700 mb-1">Account Bank Number</label>
        <input type="text" name="account_bank_number" id="account_bank_number"
               class="w-full px-3 py-2 border border-gray-300 rounded shadow-sm focus:ring-indigo-500 focus:border-indigo-500" />
        </div>
        </div>
    </div>
