...
<li class="pc-item pc-hasmenu">
        ...
        <li class="pc-item pc-caption">
         ...
         <li class="pc-item pc-hasmenu">
          ...
          <ul class="pc-submenu">
            ...
            <li class="pc-item"><a href="{{ route('hr.employee.index') }}" class="pc-link">Employees Managament</a></li>
             </ul>
            </li>
            <li class="pc-item pc-hasmenu">
          <a href="#!" class="pc-link"><span class="pc-micon"> <i data-feather="file-text"></i> </span><span
 ...
 <li class="pc-item pc-hasmenu">
         ...
         <li class="pc-item pc-hasmenu">
          ...
          <ul class="pc-submenu">
            <li class="pc-item"><a class="pc-link" href="{{ route('mr.doc.portal') }}">Document Portal</a></li>
