...
.dist-table th { text-align: left; font-size: 10px; font-weight: 600; letter-spacing: .06em; text-transform: uppercase; color: #a5a5a5; padding: 8px 10px; border-bottom: 1px solid #e5e7eb; background: #b4d9ff; }
